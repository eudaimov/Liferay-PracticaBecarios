<footer>
    <div class="d-flex flex-column flex-md-row">
        ...
        <div class="w-100 d-none d-sm-flex flex-column justify-content-center align-items-center">
            <p>Correo: <a href="mailto:#">info@grupo-sade.com</a></p>

            <p>Teléfono: <a href="callto:#">(+34) 911 533 171</a></p>

            <p>Conecta:
                <span class="m-2">
                    <a href="https://twitter.com/sadegrupo">
                ...
                <span class="m-2">
                    <a href="https://www.linkedin.com/company/1274145?trk=vsrp_companies_cluster_name&amp;trkInfo=VSRPsearchId%3A1582372391478537061181%2CVSRPtargetId%3A1274145%2CVSRPcmpt%3Acompanies_cluster">
