...
.alert-success .alert-btn[aria-expanded=true], .alert-success .alert-btn.active, .alert-success .alert-btn.show, .show > .alert-success .alert-btn.dropdown-toggle {
  background-color: #23923d;
  border-color: #23923d;
}
...
.alert-info .alert-btn[aria-expanded=true], .alert-info .alert-btn.active, .alert-info .alert-btn.show, .show > .alert-info .alert-btn.dropdown-toggle {
  background-color: #148ea1;
  border-color: #148ea1;
}
.alert-warning {
...
.alert-warning .alert-btn[aria-expanded=true], .alert-warning .alert-btn.active, .alert-warning .alert-btn.show, .show > .alert-warning .alert-btn.dropdown-toggle {
  background-color: #edb100;
  border-color: #edb100;
}
.alert-danger {
...
.alert-danger .alert-btn[aria-expanded=true], .alert-danger .alert-btn.active, .alert-danger .alert-btn.show, .show > .alert-danger .alert-btn.dropdown-toggle {
  background-color: #d32535;
  border-color: #d32535;
}
.alert-light {
